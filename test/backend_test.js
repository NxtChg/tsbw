...
// Back-end for blockchain.info testnet3 API

var backend =
{
	host:      'testnet.blockchain.info',
	home_page: 'https://testnet.blockchain.info/',
	adr_page:  'https://testnet.blockchain.info/address/',
	tx_page:   'https://testnet.blockchain.info/tx/'
...
backend.get_balance = function(adr, cb)
{
	...
	js.ajax('GET', 'https://testnet.blockchain.info/q/addressbalance/' + adr, 'cors=true', backend_balance_cb);
};//___________________________________________________________________________
...
backend.get_utxo = function(adr, cb)
{
	...
	js.ajax('GET', 'https://testnet.blockchain.info/unspent?active=' + adr, 'cors=true', backend_unspent_cb);
};//___________________________________________________________________________
...
backend.send = function(tx, cb)
{
	...
	js.ajax('POST', 'https://testnet.blockchain.info/pushtx', 'tx=' + tx, backend_send_cb);
};//___________________________________________________________________________
